function [ Val, Sci, Dev, Launch ] = SingleTradeFunction (PropType, SurfPower, Site, Food, SurfCrew, Input_ISP, varargin)
...
%     hold on
    ...
    Val = Results.Value;
    Sci = Results.Science;
    Dev = Results.Dev_Cost;
    Launch = Results.Launch_Cost;
